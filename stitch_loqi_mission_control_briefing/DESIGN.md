...
colors:
  surface: '#141313'
  surface-dim: '#0f0e0e'
  surface-bright: '#201f1f'
  surface-container-lowest: '#0f0e0e'
  surface-container-low: '#141313'
  surface-container: '#1a1a1a'
  surface-container-high: '#242424'
  surface-container-highest: '#2b2a2a'
  on-surface: '#fdf8f8'
  on-surface-variant: '#ddd9d8'
  inverse-surface: '#fdf8f8'
  ...
  on-primary-container: '#fdf8f8'
  inverse-primary: '#605e5e'
  secondary: '#ddd9d8'
  on-secondary: '#141313'
  secondary-container: '#242424'
  on-secondary-container: '#ddd9d8'
  tertiary: '#ffffff'
  on-tertiary: '#141313'
  ...
  primary-fixed: '#fdf8f8'
  primary-fixed-dim: '#ddd9d8'
  on-primary-fixed: '#141313'
  on-primary-fixed-variant: '#3a3939'
  background: '#0f0e0e'
  on-background: '#fdf8f8'
