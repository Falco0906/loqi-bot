      ...
      <AppPage className="overflow-y-auto">
        <div className="mx-auto w-full max-w-5xl space-y-8 py-4 pb-16">
          <header className="flex flex-col gap-5 border-b border-outline-variant/10 pb-7 md:flex-row md:items-end md:justify-between">
            <div><p className="mb-2 text-[10px] font-semibold uppercase tracking-[0.18em] text-primary">Evidence-backed briefing</p><h1 className="font-serif text-4xl font-normal text-on-surface">Strategic Updates</h1><p className="mt-2 max-w-xl text-sm leading-relaxed text-on-surface-variant/75">Patterns Loqi found across your outbound activity. Recommendations are suggestions only; operational state is never changed automatically.</p>{lastAnalyzed && <p className="mt-3 text-[11px] text-on-surface-variant/50">Last analyzed {dateLabel(lastAnalyzed)}</p>}</div>
