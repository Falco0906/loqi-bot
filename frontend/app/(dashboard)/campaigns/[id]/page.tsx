  ...
  if (!campaign) {
    return (
      <div className="flex flex-col items-center justify-center h-full text-center px-6">
        ...
        <p className="text-body-lg text-on-surface-variant/60">Campaign not found</p>
        <button
          onClick={() => router.push("/campaigns")}
          className="mt-4 px-5 py-2 bg-primary text-on-primary text-sm font-bold rounded-lg hover:brightness-110"
        >
          Back to Campaigns
        </button>
      </div>
